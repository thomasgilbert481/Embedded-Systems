...
#define WHEEL_PERIOD          (50000) // was 10000
#define RIGHT_FORWARD_SPEED  (TB3CCR2)  // P6.1
#define LEFT_FORWARD_SPEED   (TB3CCR3)  // P6.2
#define RIGHT_REVERSE_SPEED  (TB3CCR4)  // P6.3
#define LEFT_REVERSE_SPEED   (TB3CCR5)  // P6.4
#define STEP                   (2000)
